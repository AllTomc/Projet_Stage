...
CspOple<CspOple( IdX, X, IdY, Y )> { CspVarInt<CspVarInt( IdX, X, XDom )> } --> built-in<le( XDom, YDom )>
...
CspVarInt<CspVarInt( _, X, XDom )> { CspOple<CspOple( IdX, X, IdY, Y )>, CspOpeq<CspOpeq( IdX, X, IdY, Y )>, CspOpplus<CspOpplus( Id1, X, Id2, Y, Id3, Z )>, CspVarInt<CspVarInt( Id2, Y, YDom )> } --> built-in<( ( *XDom ) . val(  ) )>
...
(constraint) CspOple( ( +int ), ( ?int ), ( +int ), ( ?int ) ), indexes: { <0,1>, <2,3> }
...
(rule) le_var_var @ CspVarInt( IdX, X, XDom ), CspVarInt( IdY, Y, YDom ), CspOple( IdX, X, IdY, Y ) =>> ( Solvint :: le( XDom, YDom ) ) ;;
...
(occ rule) le_var_var @ [+CspOple( IdX, X, IdY, Y )#0#no_history][+CspVarInt( IdX, X, XDom )<idx#0>#no_history, +CspVarInt( IdY, Y, YDom )<idx#0>#no_history] --> ( Solvint :: le( XDom, YDom ) ) ;;
...
(occ rule) plus @ [+CspVarInt( Id1, X, XDom )#3#no_history][+CspOpplus( Id1, X, Id2, Y, Id3, Z )<idx#0>#no_history, +CspVarInt( Id3, Z, ZDom )<idx#0>#no_history, +CspVarInt( Id2, Y, YDom )<idx#0>#no_history] --> ( Solvint :: plus_boundConsistency( XDom, YDom, ZDom ) ) ;;
(occ rule) plus @ [+CspVarInt( Id2, Y, YDom )#4#no_history][+CspOpplus( Id1, X, Id2, Y, Id3, Z )<idx#1>#no_history, +CspVarInt( Id3, Z, ZDom )<idx#0>#no_history, +CspVarInt( Id1, X, XDom )<idx#0>#no_history] --> ( Solvint :: plus_boundConsistency( XDom, YDom, ZDom ) ) ;;
(occ rule) plus @ [+CspVarInt( Id3, Z, ZDom )#5#no_history][+CspOpplus( Id1, X, Id2, Y, Id3, Z )<idx#2>#no_history, +CspVarInt( Id2, Y, YDom )<idx#0>#no_history, +CspVarInt( Id1, X, XDom )<idx#0>#no_history] --> ( Solvint :: plus_boundConsistency( XDom, YDom, ZDom ) ) ;;
...
(occ rule) le_var_var @ [+CspVarInt( IdX, X, XDom )#8#no_history][+CspOple( IdX, X, IdY, Y )<idx#0>#no_history, +CspVarInt( IdY, Y, YDom )<idx#0>#no_history] --> ( Solvint :: le( XDom, YDom ) ) ;;
(occ rule) le_var_var @ [+CspVarInt( IdY, Y, YDom )#9#no_history][+CspOple( IdX, X, IdY, Y )<idx#1>#no_history, +CspVarInt( IdX, X, XDom )<idx#0>#no_history] --> ( Solvint :: le( XDom, YDom ) ) ;;
...
(constraint store) CspOple( ( +int ), ( ?int ), ( +int ), ( ?int ) ), indexes: { <0,1>, <2,3> }
...
// Rule le_var_var, active constraint CspOple( IdX, X, IdY, Y ), occurrence 0
Begin CspOple_0
If empty store CspVarInt( IdX, X, XDom ) Then goto CspOple_store
...
Begin CspVarInt_2
	...
	End guard
End
// Rule plus, active constraint CspVarInt( Id1, X, XDom ), occurrence 3
Begin CspVarInt_3
If empty store CspOpplus( Id1, X, Id2, Y, Id3, Z ) Then goto CspVarInt_4
If empty store CspVarInt( Id3, Z, ZDom ) Then goto CspVarInt_4
...
End
// Rule plus, active constraint CspVarInt( Id2, Y, YDom ), occurrence 4
Begin CspVarInt_4
If empty store CspOpplus( Id1, X, Id2, Y, Id3, Z ) Then goto CspVarInt_5
If empty store CspVarInt( Id3, Z, ZDom ) Then goto CspVarInt_5
If empty store CspVarInt( Id1, X, XDom ) Then goto CspVarInt_5
	...
	End matching partner CspOpplus( Id1, X, Id2, Y, Id3, Z )
End
// Rule plus, active constraint CspVarInt( Id3, Z, ZDom ), occurrence 5
Begin CspVarInt_5
If empty store CspOpplus( Id1, X, Id2, Y, Id3, Z ) Then goto CspVarInt_6
If empty store CspVarInt( Id2, Y, YDom ) Then goto CspVarInt_6
If empty store CspVarInt( Id1, X, XDom ) Then goto CspVarInt_6
...
If empty store CspVarInt( IdX, X, XDom ) Then goto CspVarInt_8
	...
	End matching partner CspOpeq( IdX, X, IdY, Y )
End
// Rule le_var_var, active constraint CspVarInt( IdX, X, XDom ), occurrence 8
Begin CspVarInt_8
If empty store CspOple( IdX, X, IdY, Y ) Then goto CspVarInt_9
If empty store CspVarInt( IdY, Y, YDom ) Then goto CspVarInt_9
	Matching partner CspOple( IdX, X, IdY, Y ) with idx#0<IdX,X>
		Matching partner CspVarInt( IdY, Y, YDom ) with idx#0<IdY,Y>
			If guard
				( CspVarInt( IdY, Y, YDom ) != CspVarInt( IdX, X, XDom ) )
			Then guard
				...
				( Solvint :: le( XDom, YDom ) )
				If not alived CspVarInt( IdX, X, XDom ) Then goto next goal constraint
				If not alived CspOple( IdX, X, IdY, Y ) Then goto next matching of CspOple( IdX, X, IdY, Y )
				goto next matching of CspVarInt( IdY, Y, YDom )
			End guard
		End matching partner CspVarInt( IdY, Y, YDom )
	End matching partner CspOple( IdX, X, IdY, Y )
End
// Rule le_var_var, active constraint CspVarInt( IdY, Y, YDom ), occurrence 9
Begin CspVarInt_9
...
If empty store CspVarInt( IdX, X, XDom ) Then goto CspVarInt_store
	Matching partner CspOple( IdX, X, IdY, Y ) with idx#1<IdY,Y>
		Matching partner CspVarInt( IdX, X, XDom ) with idx#0<IdX,X>
			If guard
				( CspVarInt( IdX, X, XDom ) != CspVarInt( IdY, Y, YDom ) )
			Then guard
...
public:
	...
	chr::Constraint_stores_iterator<chr::Shared_obj<typename CspVarIntDec::Constraint_store_t>,chr::Shared_obj<typename CspVarInt::Constraint_store_t>,chr::Shared_obj<typename CspTmpInt::Constraint_store_t>,chr::Shared_obj<typename CspOpplus::Constraint_store_t>,chr::Shared_obj<typename CspOpeq::Constraint_store_t>,chr::Shared_obj<typename CspOple::Constraint_store_t>> chr_store_begin() { return chr::Constraint_stores_iterator(CspVarIntDec_constraint_store,CspVarInt_constraint_store,CspTmpInt_constraint_store,CspOpplus_constraint_store,CspOpeq_constraint_store,CspOple_constraint_store); }
...
chr::ES_CHR test1::do_CspOple(typename CspOple::Type c_args, typename CspOple::Constraint_store_t::iterator c_it) {
	...
	// ***************************************************
	// CspOple_0 <=> Rule le_var_var, active constraint CspOple( IdX, X, IdY, Y ), occurrence 1
...
chr::ES_CHR test1::do_CspVarInt(typename CspVarInt::Type c_args, typename CspVarInt::Constraint_store_t::iterator c_it) {
	...
	// ***************************************************
	// CspVarInt_3 <=> Rule plus, active constraint CspVarInt( Id1, X, XDom ), occurrence 4
	[[maybe_unused]] CspVarInt_3:
	{
		...
		auto& X = std::get<2>(c_args);
		auto& XDom = std::get<3>(c_args);
		auto it3_0 = CspOpplus_constraint_store->template begin<0>(Id1,X);
		while ( !it3_0.at_end() ) {
			auto Id2(std::get<3>(*it3_0));
			auto Y(std::get<4>(*it3_0));
			auto Id3(std::get<5>(*it3_0));
			auto Z(std::get<6>(*it3_0));
			auto it3_1 = CspVarInt_constraint_store->template begin<0>(Id3,Z);
			while ( !it3_1.at_end() ) {
				...
				if (
					...
					auto it3_2 = CspVarInt_constraint_store->template begin<0>(Id2,Y);
					while ( !it3_2.at_end() ) {
	...
	// ***************************************************
	// CspVarInt_4 <=> Rule plus, active constraint CspVarInt( Id2, Y, YDom ), occurrence 5
	[[maybe_unused]] CspVarInt_4:
	{
		...
		auto it4_0 = CspOpplus_constraint_store->template begin<1>(Id2,Y);
		while ( !it4_0.at_end() ) {
			auto Id1(std::get<1>(*it4_0));
			auto X(std::get<2>(*it4_0));
			auto Id3(std::get<5>(*it4_0));
			auto Z(std::get<6>(*it4_0));
			auto it4_1 = CspVarInt_constraint_store->template begin<0>(Id3,Z);
			while ( !it4_1.at_end() ) {
				...
				if (
					...
					auto it4_2 = CspVarInt_constraint_store->template begin<0>(Id1,X);
					while ( !it4_2.at_end() ) {
	...
	// ***************************************************
	// CspVarInt_5 <=> Rule plus, active constraint CspVarInt( Id3, Z, ZDom ), occurrence 6
	[[maybe_unused]] CspVarInt_5:
	{
		...
		auto it5_0 = CspOpplus_constraint_store->template begin<2>(Id3,Z);
		while ( !it5_0.at_end() ) {
			auto Id1(std::get<1>(*it5_0));
			auto X(std::get<2>(*it5_0));
			auto Id2(std::get<3>(*it5_0));
			auto Y(std::get<4>(*it5_0));
			auto it5_1 = CspVarInt_constraint_store->template begin<0>(Id2,Y);
			while ( !it5_1.at_end() ) {
				...
				if (
					...
					auto it5_2 = CspVarInt_constraint_store->template begin<0>(Id1,X);
					while ( !it5_2.at_end() ) {
	...
	// ***************************************************
	// CspVarInt_8 <=> Rule le_var_var, active constraint CspVarInt( IdX, X, XDom ), occurrence 9
	[[maybe_unused]] CspVarInt_8:
	{
		if (CspOple_constraint_store->empty()) goto CspVarInt_9;
		if (CspVarInt_constraint_store->empty()) goto CspVarInt_9;
		auto& IdX = std::get<1>(c_args);
		auto& X = std::get<2>(c_args);
		auto& XDom = std::get<3>(c_args);
		auto it8_0 = CspOple_constraint_store->template begin<0>(IdX,X);
		while ( !it8_0.at_end() ) {
			auto IdY(std::get<3>(*it8_0));
			auto Y(std::get<4>(*it8_0));
			auto it8_1 = CspVarInt_constraint_store->template begin<0>(IdY,Y);
			while ( !it8_1.at_end() ) {
				auto YDom(std::get<3>(*it8_1));
				// Begin guard
				if (
	...
	// ***************************************************
	// CspVarInt_9 <=> Rule le_var_var, active constraint CspVarInt( IdY, Y, YDom ), occurrence 10
	[[maybe_unused]] CspVarInt_9:
	{
		...
		auto& Y = std::get<2>(c_args);
		auto& YDom = std::get<3>(c_args);
		auto it9_0 = CspOple_constraint_store->template begin<1>(IdY,Y);
		while ( !it9_0.at_end() ) {
			auto IdX(std::get<1>(*it9_0));
			auto X(std::get<2>(*it9_0));
			auto it9_1 = CspVarInt_constraint_store->template begin<0>(IdX,X);
			while ( !it9_1.at_end() ) {
				auto XDom(std::get<3>(*it9_1));
				// Begin guard
				if (
...
CHR_RUN(space->CspOpplus(1,X[1],0,X[0],3,X[3]);
space->CspOpeq(3,X[3],2,X[2]);
